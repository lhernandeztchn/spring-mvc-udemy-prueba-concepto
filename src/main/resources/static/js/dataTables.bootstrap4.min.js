...
$jscomp.getGlobal = function(a) {
	return "undefined" != typeof window && window === a ? a
	...
	"function" === typeof define && define.amd ? define([ "jquery",
		...
		(function(a, b, c, e) {
			...
			d.ext.renderer.pageButton.bootstrap = function(b, l, v, w, m, r) {
				var k = new d.Api(b), x = b.oClasses, n = b.oLanguage.oPaginate, y = b.oLanguage.oAria.paginate
						|| {}, g, h, t = 0, u = function(c, d) {
					var e, l = function(b) {
						b.preventDefault();
				...
				u(a(l).empty().html('<ul class="pagination"/>').children("ul"),
						w);
